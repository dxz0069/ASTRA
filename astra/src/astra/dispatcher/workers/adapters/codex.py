    ...
    def build_execute(self, worker: WorkerConfig, prompt: str, session: str | None) -> DriverResult:
        ...
        return DriverResult(
            argv=[
                ...
                "-c",
                'model_providers.astra.name="astra"',
                "-c",
                'model_providers.astra.wire_api="responses"',
                "-c",
                'model_reasoning_effort="high"',
                "-c",
                f'model_providers.astra.base_url="{env["CODEX_BASE_URL"]}"',
                "-c",
                'model_providers.astra.env_key="OPENAI_API_KEY"',
                "--",
                prompt,
            ]
        )
